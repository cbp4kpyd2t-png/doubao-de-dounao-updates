...
contextBridge.exposeInMainWorld('appApi', {
  ...
  getVersion: () => ipcRenderer.invoke('app:version'), getEdition: () => ipcRenderer.invoke('app:edition'), getUpdateSettings: () => ipcRenderer.invoke('update:getSettings'), chooseUpdateSource: () => ipcRenderer.invoke('update:chooseSource'), saveUpdateSettings: (settings) => ipcRenderer.invoke('update:saveSettings', settings),
